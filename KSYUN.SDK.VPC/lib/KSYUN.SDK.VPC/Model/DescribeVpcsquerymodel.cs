...
namespace KSYUN.SDK.VPC.Model.DescribeVpcs.query
{
    public class DescribeVpcsqueryModel
    {
        public JsonSchema _schema;
        public DescribeVpcsqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"DescribeVpcs\"],\"default\":\"DescribeVpcs\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"},\"VpcId\":{\"type\":\"string\"}}}");
