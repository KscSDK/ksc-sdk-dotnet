...
namespace KSYUN.SDK.VPC.Model.DescribeDirectConnectInterfaces.query
{
    public class DescribeDirectConnectInterfacesqueryModel
    {
        public JsonSchema _schema;
        public DescribeDirectConnectInterfacesqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"DescribeDirectConnectInterfaces\"],\"default\":\"DescribeDirectConnectInterfaces\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"}}}");
