...
namespace KSYUN.SDK.VPC.Model.DescribeDirectConnectGateways.query
{
    public class DescribeDirectConnectGatewaysqueryModel
    {
        public JsonSchema _schema;
        public DescribeDirectConnectGatewaysqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"DescribeDirectConnectGateways\"],\"default\":\"DescribeDirectConnectGateways\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"}}}");
