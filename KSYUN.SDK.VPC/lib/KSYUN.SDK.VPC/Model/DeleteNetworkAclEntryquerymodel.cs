...
namespace KSYUN.SDK.VPC.Model.DeleteNetworkAclEntry.query
{
    public class DeleteNetworkAclEntryqueryModel
    {
        public JsonSchema _schema;
        public DeleteNetworkAclEntryqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"DeleteNetworkAclEntry\"],\"default\":\"DeleteNetworkAclEntry\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"},\"NetworkAclEntryId\":{\"type\":\"string\"},\"NetworkAclId\":{\"type\":\"string\"}}}");
