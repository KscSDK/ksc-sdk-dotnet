...
namespace KSYUN.SDK.VPC.Model.DeleteSubnet.query
{
    public class DeleteSubnetqueryModel
    {
        public JsonSchema _schema;
        public DeleteSubnetqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"DeleteSubnet\"],\"default\":\"DeleteSubnet\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"},\"SubnetId\":{\"type\":\"string\"}}}");
