...
namespace KSYUN.SDK.VPC.Model.ModifyVpnTunnel.query
{
    public class ModifyVpnTunnelqueryModel
    {
        public JsonSchema _schema;
        public ModifyVpnTunnelqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"ModifyVpnTunnel\"],\"default\":\"ModifyVpnTunnel\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"},\"VpnTunnelId\":{\"type\":\"string\"},\"VpnTunnelName\":{\"type\":\"string\"}}}");
