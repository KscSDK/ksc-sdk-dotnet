...
namespace KSYUN.SDK.VPC.Model.CreateDirectConnectGateway.query
{
    public class CreateDirectConnectGatewayqueryModel
    {
        public JsonSchema _schema;
        public CreateDirectConnectGatewayqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"CreateDirectConnectGateway\"],\"default\":\"CreateDirectConnectGateway\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"}}}");
