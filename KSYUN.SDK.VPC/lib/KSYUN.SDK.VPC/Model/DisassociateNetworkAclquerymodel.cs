...
namespace KSYUN.SDK.VPC.Model.DisassociateNetworkAcl.query
{
    public class DisassociateNetworkAclqueryModel
    {
        public JsonSchema _schema;
        public DisassociateNetworkAclqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"DisassociateNetworkAcl\"],\"default\":\"DisassociateNetworkAcl\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"},\"SubnetId\":{\"type\":\"string\"},\"NetworkAclId\":{\"type\":\"string\"}}}");
