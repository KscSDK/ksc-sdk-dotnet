...
namespace KSYUN.SDK.VPC.Model.DisassociateRemoteCidr.query
{
    public class DisassociateRemoteCidrqueryModel
    {
        public JsonSchema _schema;
        public DisassociateRemoteCidrqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"DisassociateRemoteCidr\"],\"default\":\"DisassociateRemoteCidr\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"}}}");
