...
namespace KSYUN.SDK.VPC.Model.ModifyDirectConnectInterface.query
{
    public class ModifyDirectConnectInterfacequeryModel
    {
        public JsonSchema _schema;
        public ModifyDirectConnectInterfacequeryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"ModifyDirectConnectInterface\"],\"default\":\"ModifyDirectConnectInterface\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"}}}");
