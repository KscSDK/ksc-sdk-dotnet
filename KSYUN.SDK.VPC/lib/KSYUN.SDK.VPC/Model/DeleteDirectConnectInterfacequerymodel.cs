...
namespace KSYUN.SDK.VPC.Model.DeleteDirectConnectInterface.query
{
    public class DeleteDirectConnectInterfacequeryModel
    {
        public JsonSchema _schema;
        public DeleteDirectConnectInterfacequeryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"DeleteDirectConnectInterface\"],\"default\":\"DeleteDirectConnectInterface\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"}}}");
