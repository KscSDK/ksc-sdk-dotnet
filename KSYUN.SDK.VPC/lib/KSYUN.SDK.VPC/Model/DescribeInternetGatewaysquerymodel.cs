...
namespace KSYUN.SDK.VPC.Model.DescribeInternetGateways.query
{
    public class DescribeInternetGatewaysqueryModel
    {
        public JsonSchema _schema;
        public DescribeInternetGatewaysqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"DescribeInternetGateways\"],\"default\":\"DescribeInternetGateways\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"},\"InternetGatewayId\":{\"type\":\"string\"},\"Filter\":{\"type\":\"string\"}}}");
