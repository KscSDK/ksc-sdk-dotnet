...
namespace KSYUN.SDK.VPC.Model.AssociateNetworkAcl.query
{
    public class AssociateNetworkAclqueryModel
    {
        public JsonSchema _schema;
        public AssociateNetworkAclqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"AssociateNetworkAcl\"],\"default\":\"AssociateNetworkAcl\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"},\"SubnetId\":{\"type\":\"string\"},\"NetworkAclId\":{\"type\":\"string\"}}}");
