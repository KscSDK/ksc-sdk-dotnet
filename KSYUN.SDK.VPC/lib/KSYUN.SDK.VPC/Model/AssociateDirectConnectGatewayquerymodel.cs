...
namespace KSYUN.SDK.VPC.Model.AssociateDirectConnectGateway.query
{
    public class AssociateDirectConnectGatewayqueryModel
    {
        public JsonSchema _schema;
        public AssociateDirectConnectGatewayqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"AssociateDirectConnectGateway\"],\"default\":\"AssociateDirectConnectGateway\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"}}}");
