...
namespace KSYUN.SDK.VPC.Model.CreateCustomerGateway.query
{
    public class CreateCustomerGatewayqueryModel
    {
        public JsonSchema _schema;
        public CreateCustomerGatewayqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"CreateCustomerGateway\"],\"default\":\"CreateCustomerGateway\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"},\"CustomerGatewayAddress\":{\"type\":\"string\"},\"HaCustomerGatewayAddress\":{\"type\":\"string\"},\"CustomerGatewayName\":{\"type\":\"string\"}}}");
