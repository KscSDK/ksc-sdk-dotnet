...
namespace KSYUN.SDK.VPC.Model.CreateVpcPeeringConnection.query
{
    public class CreateVpcPeeringConnectionqueryModel
    {
        public JsonSchema _schema;
        public CreateVpcPeeringConnectionqueryModel()
        {
