...
namespace KSYUN.SDK.VPC.Model.DescribeTunnels.query
{
    public class DescribeTunnelsqueryModel
    {
        public JsonSchema _schema;
        public DescribeTunnelsqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"DescribeTunnels\"],\"default\":\"DescribeTunnels\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"}}}");
