...
namespace KSYUN.SDK.VPC.Model.DeleteRoute.query
{
    public class DeleteRoutequeryModel
    {
        public JsonSchema _schema;
        public DeleteRoutequeryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"DeleteRoute\"],\"default\":\"DeleteRoute\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"},\"RouteId\":{\"type\":\"string\"}}}");
