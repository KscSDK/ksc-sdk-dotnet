...
namespace KSYUN.SDK.VPC.Model.DescribeNats.query
{
    public class DescribeNatsqueryModel
    {
        public JsonSchema _schema;
        public DescribeNatsqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"DescribeNats\"],\"default\":\"DescribeNats\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"},\"NatId\":{\"type\":\"string\"},\"Filter\":{\"type\":\"string\"}}}");
