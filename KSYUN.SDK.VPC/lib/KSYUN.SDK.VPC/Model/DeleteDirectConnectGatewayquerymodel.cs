...
namespace KSYUN.SDK.VPC.Model.DeleteDirectConnectGateway.query
{
    public class DeleteDirectConnectGatewayqueryModel
    {
        public JsonSchema _schema;
        public DeleteDirectConnectGatewayqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"DeleteDirectConnectGateway\"],\"default\":\"DeleteDirectConnectGateway\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"}}}");
