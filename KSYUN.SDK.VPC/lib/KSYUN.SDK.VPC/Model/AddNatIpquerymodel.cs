...
namespace KSYUN.SDK.VPC.Model.AddNatIp.query
{
    public class AddNatIpqueryModel
    {
        public JsonSchema _schema;
        public AddNatIpqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"AddNatIp\"],\"default\":\"AddNatIp\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"}}}");
