...
namespace KSYUN.SDK.VPC.Model.DeleteCustomerGateway.query
{
    public class DeleteCustomerGatewayqueryModel
    {
        public JsonSchema _schema;
        public DeleteCustomerGatewayqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"DeleteCustomerGateway\"],\"default\":\"DeleteCustomerGateway\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"},\"CustomerGatewayId\":{\"type\":\"string\"}}}");
