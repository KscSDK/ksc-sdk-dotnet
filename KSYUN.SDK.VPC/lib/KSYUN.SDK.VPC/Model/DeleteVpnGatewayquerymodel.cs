...
namespace KSYUN.SDK.VPC.Model.DeleteVpnGateway.query
{
    public class DeleteVpnGatewayqueryModel
    {
        public JsonSchema _schema;
        public DeleteVpnGatewayqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"DeleteVpnGateway\"],\"default\":\"DeleteVpnGateway\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"},\"VpnGatewayId\":{\"type\":\"string\"}}}");
