...
namespace KSYUN.SDK.VPC.Model.DescribeNetworkInterfaces.query
{
    public class DescribeNetworkInterfacesqueryModel
    {
        public JsonSchema _schema;
        public DescribeNetworkInterfacesqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"DescribeNetworkInterfaces\"],\"default\":\"DescribeNetworkInterfaces\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"},\"NetworkInterfaceId\":{\"type\":\"string\"},\"Filter\":{\"type\":\"string\"}}}");
