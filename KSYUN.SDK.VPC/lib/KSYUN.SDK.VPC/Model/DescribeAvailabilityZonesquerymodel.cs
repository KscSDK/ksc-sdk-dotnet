...
namespace KSYUN.SDK.VPC.Model.DescribeAvailabilityZones.query
{
    public class DescribeAvailabilityZonesqueryModel
    {
        ...
        public DescribeAvailabilityZonesqueryModel()
        {
            ...
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"DescribeAvailabilityZones\"],\"default\":\"DescribeAvailabilityZones\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"}}}");
