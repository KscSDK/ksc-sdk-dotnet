...
namespace KSYUN.SDK.VPC.Model.AssociateSubnet.query
{
    public class AssociateSubnetqueryModel
    {
        public JsonSchema _schema;
        public AssociateSubnetqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"AssociateSubnet\"],\"default\":\"AssociateSubnet\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"}}}");
