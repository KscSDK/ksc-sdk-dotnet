...
namespace KSYUN.SDK.VPC.Model.DescribeDirectConnects.query
{
    public class DescribeDirectConnectsqueryModel
    {
        public JsonSchema _schema;
        public DescribeDirectConnectsqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"DescribeDirectConnects\"],\"default\":\"DescribeDirectConnects\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"}}}");
