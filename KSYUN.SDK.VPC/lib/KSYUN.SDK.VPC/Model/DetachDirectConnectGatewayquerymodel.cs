...
namespace KSYUN.SDK.VPC.Model.DetachDirectConnectGateway.query
{
    public class DetachDirectConnectGatewayqueryModel
    {
        public JsonSchema _schema;
        public DetachDirectConnectGatewayqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"DetachDirectConnectGateway\"],\"default\":\"DetachDirectConnectGateway\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"}}}");
