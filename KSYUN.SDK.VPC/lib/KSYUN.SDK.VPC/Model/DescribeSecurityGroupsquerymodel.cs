...
namespace KSYUN.SDK.VPC.Model.DescribeSecurityGroups.query
{
    public class DescribeSecurityGroupsqueryModel
    {
        public JsonSchema _schema;
        public DescribeSecurityGroupsqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"DescribeSecurityGroups\"],\"default\":\"DescribeSecurityGroups\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"},\"SecurityGroupId\":{\"type\":\"string\"},\"Filter\":{\"type\":\"string\"}}}");
