...
namespace KSYUN.SDK.VPC.Model.ModifyTunnel.query
{
    public class ModifyTunnelqueryModel
    {
        public JsonSchema _schema;
        public ModifyTunnelqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"ModifyTunnel\"],\"default\":\"ModifyTunnel\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"}}}");
