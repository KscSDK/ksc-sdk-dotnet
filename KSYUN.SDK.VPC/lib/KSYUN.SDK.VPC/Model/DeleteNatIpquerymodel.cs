...
namespace KSYUN.SDK.VPC.Model.DeleteNatIp.query
{
    public class DeleteNatIpqueryModel
    {
        public JsonSchema _schema;
        public DeleteNatIpqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"DeleteNatIp\"],\"default\":\"DeleteNatIp\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"}}}");
