...
namespace KSYUN.SDK.VPC.Model.DisassociateSubnet.query
{
    public class DisassociateSubnetqueryModel
    {
        public JsonSchema _schema;
        public DisassociateSubnetqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"DisassociateSubnet\"],\"default\":\"DisassociateSubnet\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"}}}");
