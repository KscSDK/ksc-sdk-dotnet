...
namespace KSYUN.SDK.VPC.Model.ModifyNetworkAcl.query
{
    public class ModifyNetworkAclqueryModel
    {
        public JsonSchema _schema;
        public ModifyNetworkAclqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"ModifyNetworkAcl\"],\"default\":\"ModifyNetworkAcl\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"},\"NetworkAclName\":{\"type\":\"string\"}}}");
