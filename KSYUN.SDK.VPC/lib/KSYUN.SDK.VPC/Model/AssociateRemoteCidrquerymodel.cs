...
namespace KSYUN.SDK.VPC.Model.AssociateRemoteCidr.query
{
    public class AssociateRemoteCidrqueryModel
    {
        public JsonSchema _schema;
        public AssociateRemoteCidrqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"AssociateRemoteCidr\"],\"default\":\"AssociateRemoteCidr\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"}}}");
