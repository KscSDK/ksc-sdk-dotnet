...
namespace KSYUN.SDK.VPC.Model.DisassociateVpnGateway.query
{
    public class DisassociateVpnGatewayqueryModel
    {
        public JsonSchema _schema;
        public DisassociateVpnGatewayqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"DisassociateVpnGateway\"],\"default\":\"DisassociateVpnGateway\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"}}}");
