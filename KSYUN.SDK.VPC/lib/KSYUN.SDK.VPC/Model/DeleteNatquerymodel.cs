...
namespace KSYUN.SDK.VPC.Model.DeleteNat.query
{
    public class DeleteNatqueryModel
    {
        public JsonSchema _schema;
        public DeleteNatqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"DeleteNat\"],\"default\":\"DeleteNat\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"},\"NatId\":{\"type\":\"string\"}}}");
