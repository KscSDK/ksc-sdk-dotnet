...
namespace KSYUN.SDK.VPC.Model.AttachDirectConnectGateway.query
{
    public class AttachDirectConnectGatewayqueryModel
    {
        public JsonSchema _schema;
        public AttachDirectConnectGatewayqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"AttachDirectConnectGateway\"],\"default\":\"AttachDirectConnectGateway\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"}}}");
