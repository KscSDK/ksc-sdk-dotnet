...
namespace KSYUN.SDK.VPC.Model.AssociateVpnGateway.query
{
    public class AssociateVpnGatewayqueryModel
    {
        public JsonSchema _schema;
        public AssociateVpnGatewayqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"AssociateVpnGateway\"],\"default\":\"AssociateVpnGateway\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"}}}");
