...
namespace KSYUN.SDK.VPC.Model.DeleteVpnTunnel.query
{
    public class DeleteVpnTunnelqueryModel
    {
        public JsonSchema _schema;
        public DeleteVpnTunnelqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"DeleteVpnTunnel\"],\"default\":\"DeleteVpnTunnel\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"},\"VpnTunnelId\":{\"type\":\"string\"}}}");
