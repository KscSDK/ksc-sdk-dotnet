...
namespace KSYUN.SDK.VPC.Model.DisassociateDirectConnectGateway.query
{
    public class DisassociateDirectConnectGatewayqueryModel
    {
        public JsonSchema _schema;
        public DisassociateDirectConnectGatewayqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"DisassociateDirectConnectGateway\"],\"default\":\"DisassociateDirectConnectGateway\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"}}}");
