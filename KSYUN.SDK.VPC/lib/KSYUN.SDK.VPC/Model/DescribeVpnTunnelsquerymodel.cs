...
namespace KSYUN.SDK.VPC.Model.DescribeVpnTunnels.query
{
    public class DescribeVpnTunnelsqueryModel
    {
        public JsonSchema _schema;
        public DescribeVpnTunnelsqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"DescribeVpnTunnels\"],\"default\":\"DescribeVpnTunnels\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"},\"VpnTunnelId\":{\"type\":\"string\"},\"Filter\":{\"type\":\"string\"}}}");
