...
namespace KSYUN.SDK.VPC.Model.DescribeCustomerGateways.query
{
    public class DescribeCustomerGatewaysqueryModel
    {
        public JsonSchema _schema;
        public DescribeCustomerGatewaysqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"DescribeCustomerGateways\"],\"default\":\"DescribeCustomerGateways\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"},\"CustomerGatewayId\":{\"type\":\"string\"},\"Filter\":{\"type\":\"string\"}}}");
