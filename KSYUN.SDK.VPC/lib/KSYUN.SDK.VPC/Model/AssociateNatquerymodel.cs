...
namespace KSYUN.SDK.VPC.Model.AssociateNat.query
{
    public class AssociateNatqueryModel
    {
        public JsonSchema _schema;
        public AssociateNatqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"AssociateNat\"],\"default\":\"AssociateNat\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"},\"NatId\":{\"type\":\"string\"},\"SubnetId\":{\"type\":\"string\"}}}");
