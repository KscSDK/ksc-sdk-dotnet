...
namespace KSYUN.SDK.VPC.Model.CreateSecurityGroup.query
{
    public class CreateSecurityGroupqueryModel
    {
        public JsonSchema _schema;
        public CreateSecurityGroupqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"CreateSecurityGroup\"],\"default\":\"CreateSecurityGroup\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"},\"VpcId\":{\"type\":\"string\"},\"SecurityGroupName\":{\"type\":\"string\",\"default\":\"Ksc_SecurityGroup\"}}}");
