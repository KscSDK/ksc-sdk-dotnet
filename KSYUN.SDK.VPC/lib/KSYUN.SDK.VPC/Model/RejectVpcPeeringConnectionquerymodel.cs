...
namespace KSYUN.SDK.VPC.Model.RejectVpcPeeringConnection.query
{
    public class RejectVpcPeeringConnectionqueryModel
    {
        public JsonSchema _schema;
        public RejectVpcPeeringConnectionqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"RejectVpcPeeringConnection\"],\"default\":\"RejectVpcPeeringConnection\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"},\"VpcPeeringConnectionId\":{\"type\":\"string\"}}}");
