...
namespace KSYUN.SDK.VPC.Model.ModifyDirectConnectGateway.query
{
    public class ModifyDirectConnectGatewayqueryModel
    {
        public JsonSchema _schema;
        public ModifyDirectConnectGatewayqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"ModifyDirectConnectGateway\"],\"default\":\"ModifyDirectConnectGateway\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"}}}");
