...
namespace KSYUN.SDK.KCM.Model.DeleteCertificate.query
{
    public class DeleteCertificatequeryModel
    {
        public JsonSchema _schema;
        public DeleteCertificatequeryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"DeleteCertificate\"],\"default\":\"DeleteCertificate\"},\"CertificateId\":{\"type\":\"string\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"}}}");
