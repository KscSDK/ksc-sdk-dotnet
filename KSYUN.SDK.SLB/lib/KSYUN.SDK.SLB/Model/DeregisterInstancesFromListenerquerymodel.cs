...
namespace KSYUN.SDK.SLB.Model.DeregisterInstancesFromListener.query
{
    public class DeregisterInstancesFromListenerqueryModel
    {
        public JsonSchema _schema;
        public DeregisterInstancesFromListenerqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"DeregisterInstancesFromListener\"],\"default\":\"DeregisterInstancesFromListener\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"},\"RegisterId\":{\"type\":\"string\"}}}");
