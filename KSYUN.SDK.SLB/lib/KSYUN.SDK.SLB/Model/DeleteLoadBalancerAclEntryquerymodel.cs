...
namespace KSYUN.SDK.SLB.Model.DeleteLoadBalancerAclEntry.query
{
    public class DeleteLoadBalancerAclEntryqueryModel
    {
        public JsonSchema _schema;
        public DeleteLoadBalancerAclEntryqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"DeleteLoadBalancerAclEntry\"],\"default\":\"DeleteLoadBalancerAclEntry\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"},\"LoadBalancerAclId\":{\"type\":\"string\"},\"LoadBalancerAclEntryId\":{\"type\":\"string\"}}}");
