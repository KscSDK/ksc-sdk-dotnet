...
namespace KSYUN.SDK.SLB.Model.DeleteHealthCheck.query
{
    public class DeleteHealthCheckqueryModel
    {
        public JsonSchema _schema;
        public DeleteHealthCheckqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"DeleteHealthCheck\"],\"default\":\"DeleteHealthCheck\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"},\"HealthCheckId\":{\"type\":\"string\"}}}");
