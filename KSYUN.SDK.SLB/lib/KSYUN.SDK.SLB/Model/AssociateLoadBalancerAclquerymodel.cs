...
namespace KSYUN.SDK.SLB.Model.AssociateLoadBalancerAcl.query
{
    public class AssociateLoadBalancerAclqueryModel
    {
        public JsonSchema _schema;
        public AssociateLoadBalancerAclqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"AssociateLoadBalancerAcl\"],\"default\":\"AssociateLoadBalancerAcl\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"},\"LoadBalancerAclId\":{\"type\":\"string\"},\"ListenerId\":{\"type\":\"string\"}}}");
