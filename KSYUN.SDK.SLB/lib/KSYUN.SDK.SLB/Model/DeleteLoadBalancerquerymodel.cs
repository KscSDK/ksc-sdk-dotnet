...
namespace KSYUN.SDK.SLB.Model.DeleteLoadBalancer.query
{
    public class DeleteLoadBalancerqueryModel
    {
        public JsonSchema _schema;
        public DeleteLoadBalancerqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"DeleteLoadBalancer\"],\"default\":\"DeleteLoadBalancer\"},\"LoadBalancerId\":{\"type\":\"string\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"}}}");
