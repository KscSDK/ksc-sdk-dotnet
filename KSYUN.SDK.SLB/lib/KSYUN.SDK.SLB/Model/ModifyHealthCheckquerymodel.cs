...
namespace KSYUN.SDK.SLB.Model.ModifyHealthCheck.query
{
    public class ModifyHealthCheckqueryModel
    {
        public JsonSchema _schema;
        public ModifyHealthCheckqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"ModifyHealthCheck\"],\"default\":\"ModifyHealthCheck\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"},\"HealthCheckId\":{\"type\":\"string\"},\"HealthCheckState\":{\"type\":\"string\",\"default\":\"start\"},\"HealthyThreshold\":{\"type\":\"integer\"},\"Interval\":{\"type\":\"integer\"},\"Timeout\":{\"type\":\"integer\"},\"UnhealthyThreshold\":{\"type\":\"integer\"},\"UrlPath\":{\"type\":\"string\"},\"IsDefaultHostName\":{\"type\":\"boolean\",\"default\":true},\"HostName\":{\"type\":\"string\"}}}");
