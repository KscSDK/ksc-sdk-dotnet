...
namespace KSYUN.SDK.SLB.Model.DeleteListeners.query
{
    public class DeleteListenersqueryModel
    {
        public JsonSchema _schema;
        public DeleteListenersqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"DeleteListeners\"],\"default\":\"DeleteListeners\"},\"ListenerId\":{\"type\":\"string\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"}}}");
