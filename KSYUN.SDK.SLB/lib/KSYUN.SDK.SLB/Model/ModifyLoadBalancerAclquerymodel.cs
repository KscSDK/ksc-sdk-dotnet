...
namespace KSYUN.SDK.SLB.Model.ModifyLoadBalancerAcl.query
{
    public class ModifyLoadBalancerAclqueryModel
    {
        public JsonSchema _schema;
        public ModifyLoadBalancerAclqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"ModifyLoadBalancerAcl\"],\"default\":\"ModifyLoadBalancerAcl\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"},\"LoadBalancerAclId\":{\"type\":\"string\"},\"LoadBalancerAclName\":{\"type\":\"string\"}}}");
