...
namespace KSYUN.SDK.SLB.Model.DeleteLoadBalancerAcl.query
{
    public class DeleteLoadBalancerAclqueryModel
    {
        public JsonSchema _schema;
        public DeleteLoadBalancerAclqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"DeleteLoadBalancerAcl\"],\"default\":\"DeleteLoadBalancerAcl\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"},\"LoadBalancerAclId\":{\"type\":\"string\"}}}");
