...
namespace KSYUN.SDK.EIP.Model.RegionList.query
{
    public class RegionListqueryModel
    {
        public JsonSchema _schema;
        public RegionListqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"RegionList\"],\"default\":\"RegionList\"},\"Version\":{\"type\":\"string\",\"default\":\"2016-03-04\"}}}");
