...
namespace KSYUN.SDK.SMS.Model.SendSms.body
{
    public class SendSmsbodyModel
    {
        public JsonSchema _schema;
        public SendSmsbodyModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Mobile\":{\"type\":\"string\"},\"SignName\":{\"type\":\"string\"},\"TplId\":{\"type\":\"string\"},\"TplParams\":{\"type\":\"string\"},\"Content\":{\"type\":\"string\"},\"SmsType\":{\"type\":\"integer\"}}}");
