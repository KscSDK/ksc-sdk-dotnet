...
namespace KSYUN.SDK.KEC.Model.DescribeImages.query
{
    public class DescribeImagesqueryModel
    {
        public JsonSchema _schema;
        public DescribeImagesqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"description\":\"Action 描述镜像信息\",\"enum\":[\"DescribeImages\"],\"default\":\"DescribeImages\"},\"Version\":{\"type\":\"string\",\"description\":\"Action Version\",\"enum\":[\"2016-03-04\"],\"default\":\"2016-03-04\"},\"ImageId\":{\"type\":\"string\"}},\"required\":[\"Action\",\"Version\"]}");
