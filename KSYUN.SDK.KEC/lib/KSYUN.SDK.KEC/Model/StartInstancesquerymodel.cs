...
namespace KSYUN.SDK.KEC.Model.StartInstances.query
{
    public class StartInstancesqueryModel
    {
        public JsonSchema _schema;
        public StartInstancesqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"description\":\"Action 启动实例\",\"enum\":[\"StartInstances\"],\"default\":\"StartInstances\"},\"Version\":{\"type\":\"string\",\"description\":\"Action Version\",\"enum\":[\"2016-03-04\"],\"default\":\"2016-03-04\"},\"InstanceId\":{\"type\":\"array\",\"items\":{\"type\":\"string\"}}},\"required\":[\"Action\",\"Version\"]}");
