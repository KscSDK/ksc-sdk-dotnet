...
namespace KSYUN.SDK.KEC.Model.DescribeInstanceVnc.query
{
    public class DescribeInstanceVncqueryModel
    {
        public JsonSchema _schema;
        public DescribeInstanceVncqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"description\":\"Action 获取指定实例的VNC信息\",\"enum\":[\"DescribeInstanceVnc\"],\"default\":\"DescribeInstanceVnc\"},\"Version\":{\"type\":\"string\",\"description\":\"Action Version\",\"enum\":[\"2016-03-04\"],\"default\":\"2016-03-04\"},\"InstanceId\":{\"type\":\"string\"}},\"required\":[\"Action\",\"Version\"]}");
