...
namespace KSYUN.SDK.KEC.Model.DescribeInstanceFamilys.query
{
    public class DescribeInstanceFamilysqueryModel
    {
        public JsonSchema _schema;
        public DescribeInstanceFamilysqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"description\":\"Action 查询机型配置信息\",\"enum\":[\"DescribeInstanceFamilys\"],\"default\":\"DescribeInstanceFamilys\"},\"Version\":{\"type\":\"string\",\"description\":\"Action Version\",\"enum\":[\"2016-03-04\"],\"default\":\"2016-03-04\"}},\"required\":[\"Action\",\"Version\"]}");
