...
namespace KSYUN.SDK.KEC.Model.UnmonitorInstances.query
{
    public class UnmonitorInstancesqueryModel
    {
        public JsonSchema _schema;
        public UnmonitorInstancesqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"UnmonitorInstances\"],\"default\":\"UnmonitorInstances\"},\"Version\":{\"type\":\"string\",\"enum\":[\"2016-03-04\"],\"default\":\"2016-03-04\"},\"InstanceId\":{\"type\":\"array\",\"items\":{\"type\":\"string\"}}},\"required\":[\"Action\",\"Version\"]}");
