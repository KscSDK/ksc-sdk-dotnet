...
namespace KSYUN.SDK.KEC.Model.DeleteLocalVolumeSnapshot.query
{
    public class DeleteLocalVolumeSnapshotqueryModel
    {
        public JsonSchema _schema;
        public DeleteLocalVolumeSnapshotqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"description\":\"Action 删除快照\",\"enum\":[\"DeleteLocalVolumeSnapshot\"],\"default\":\"DeleteLocalVolumeSnapshot\"},\"Version\":{\"type\":\"string\",\"description\":\"Action Version\",\"enum\":[\"2016-03-04\"],\"default\":\"2016-03-04\"},\"LocalVolumeSnapshotId\":{\"type\":\"string\"}},\"required\":[\"Action\",\"Version\"]}");
