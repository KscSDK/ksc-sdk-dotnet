...
namespace KSYUN.SDK.KEC.Model.DetachKey.query
{
    public class DetachKeyqueryModel
    {
        public JsonSchema _schema;
        public DetachKeyqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"description\":\"Action 主机解绑密钥\",\"enum\":[\"DetachKey\"],\"default\":\"DetachKey\"},\"Version\":{\"type\":\"string\",\"description\":\"Action Version\",\"enum\":[\"2016-03-04\"],\"default\":\"2016-03-04\"},\"InstanceId\":{\"type\":\"array\",\"items\":{\"type\":\"string\"}},\"KeyId\":{\"type\":\"array\",\"description\":\"密钥ID\",\"items\":{\"type\":\"string\"}}},\"required\":[\"Action\",\"Version\"]}");
