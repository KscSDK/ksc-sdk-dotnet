...
namespace KSYUN.SDK.KEC.Model.MonitorInstances.query
{
    public class MonitorInstancesqueryModel
    {
        public JsonSchema _schema;
        public MonitorInstancesqueryModel()
        {
            JsonSerializer serializer = new JsonSerializer();
            JsonValue json = JsonValue.Parse("{\"type\":\"object\",\"properties\":{\"Action\":{\"type\":\"string\",\"enum\":[\"MonitorInstances\"],\"default\":\"MonitorInstances\"},\"Version\":{\"type\":\"string\",\"enum\":[\"2016-03-04\"],\"default\":\"2016-03-04\"},\"InstanceId\":{\"type\":\"array\",\"items\":{\"type\":\"string\"}}},\"required\":[\"Action\",\"Version\"]}");
